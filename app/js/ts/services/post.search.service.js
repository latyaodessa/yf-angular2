...
var PostSearchService = (function () {
    function PostSearchService(http, elasticClient, yfPostHandler) {
        this.http = http;
        this.elasticClient = elasticClient;
        this.yfPostHandler = yfPostHandler;
    }
    PostSearchService.prototype.findByText = function (from, size, textQuery) {
