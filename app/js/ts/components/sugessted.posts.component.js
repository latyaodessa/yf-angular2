...
var SuggestedPostsComponent = (function () {
    function SuggestedPostsComponent(postService, route, postWorkflow) {
        ...
        this.subParams = this.route.params.subscribe(function (params) {
            _this.subFindById = _this.postService.findYFPostById(params['id']).subscribe(function (post) {
                ...
                _this.subSuggestedPost = _this.postService.findByText(0, 20, query).subscribe(function (data) {
                    _this.postListDTO = _this.postWorkflow.findSuggestedPosts(data, _this.postDetailsDTO.id);
                    if (_this.postListDTO.length < 4) {
                        _this.subNewPosts = _this.postService.getYFSetsNativeNew(0, 4 - _this.postListDTO.length).subscribe(function (data) {
                            console.log(data);
