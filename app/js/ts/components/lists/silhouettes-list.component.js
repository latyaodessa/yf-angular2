...
var SilhouettesListComponent = (function () {
    function SilhouettesListComponent(postService, route, windowSize, titleService) {
        this.postService = postService;
        this.route = route;
        this.windowSize = windowSize;
        this.titleService = titleService;
        this.tag = setup_config_1.SetupConfig.SILHOUETTES_LIST_ROUTE;
    ...
    SilhouettesListComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SilhouettesListComponent.prototype.getPosts = function (size) {
        var _this = this;
    ...
    SilhouettesListComponent.prototype.ngOnDestroy = function () {
        this.sub.unsubscribe();
    };
    SilhouettesListComponent.prototype.setTitle = function (title) {
        this.titleService.setTitle(title);
    };
    SilhouettesListComponent = __decorate([
        core_1.Component({
    ...
    ], SilhouettesListComponent);
    return SilhouettesListComponent;
}());
exports.SilhouettesListComponent = SilhouettesListComponent;
//# sourceMappingURL=silhouettes-list.component.js.map