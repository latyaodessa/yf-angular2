...
var SocialAuthorizationComponent = (function () {
    function SocialAuthorizationComponent(router, postService, route, authorizationService) {
        ...
        fragment.subscribe(function (params) {
            authorizationService.authorizeUser(window.location.hash);
        });
    }
    ...
    SocialAuthorizationComponent = __decorate([
        core_1.Component({
            ...
            providers: [post_service_1.PostService, elastic_client_service_1.ElasticClient, yf_post_handlers_1.YFPostHandler, authorization_service_1.AuthorizationService, vk_rest_client_1.VKRestClient],
